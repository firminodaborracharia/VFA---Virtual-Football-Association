...
const pt = {
  ...
  home: {
    ...
    categories: 'Explore',
    noClubs: 'Nenhum clube cadastrado',
    noClubsHelp: 'Cadastre os clubes da VFA no painel para eles aparecerem aqui.',
    noPlayers: 'Nenhum jogador cadastrado',
    noPlayersHelp: 'Cadastre os jogadores no painel; o rank aparece junto com o overall.',
  },
  ...
  standings: {
    ...
    goalsAgainst: 'GS',
    goalDifference: 'SG',
    goalsForFull: 'Gols marcados',
    goalsAgainstFull: 'Gols sofridos',
    goalDifferenceFull: 'Saldo de gols (marcados − sofridos)',
    percentage: '%',
    lastFive: 'Últimos 5',
...
const en: Dictionary = {
  ...
  home: {
    ...
    noClubsHelp: 'Add the VFA clubs in the panel and they show up here.',
    noPlayers: 'No players registered',
    noPlayersHelp: 'Add players in the panel; the rank appears alongside the overall.',
  },
  ...
  standings: {
    ...
    goalDifferenceFull: 'Goal difference (for − against)',
    percentage: '%',
    lastFive: 'Last 5',
...
const es: Dictionary = {
  ...
  home: {
    ...
    categories: 'Explora',
    noClubs: 'Ningún club registrado',
    noClubsHelp: 'Registra los clubes de la VFA en el panel y aparecerán aquí.',
    noPlayers: 'Ningún jugador registrado',
    noPlayersHelp: 'Registra jugadores en el panel; el rank aparece junto al overall.',
  },
  ...
  standings: {
    ...
    goalDifferenceFull: 'Diferencia de goles (a favor − en contra)',
    percentage: '%',
    lastFive: 'Últimos 5',
